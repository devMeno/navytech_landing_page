...
export default function Portfolio(){
    return(
        <div className={'text-center text-white bg-[#000816] px-[25px] md:px-[125px] py-[35px] md:py-[80px]'}>
            ...
            <button type="button"
                    className="text-white text-[24px] bg-[#003BA4] h-[60px] md:h-[82px] mb-[25px] w-[200px] md:w-[323px] mt-[35px] md:mt-[80px] font-medium rounded-lg text-sm px-5 py-2.5 me-2 text-center">
                <span className={'inline-block'}><span className={'text-[15px] md:text-[24px] flex items-center mx-auto'}>View more<GoArrowRight className={'w-34px] h-[34px] ml-[10px]'}/></span></span>
            </button>
        </div>
    )
}